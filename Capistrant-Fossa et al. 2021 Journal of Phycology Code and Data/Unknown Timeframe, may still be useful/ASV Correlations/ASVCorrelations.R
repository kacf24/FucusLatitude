...
setwd("~/Desktop/TransatlanticData/ASV Correlations/SIMPER")
...
SIMPER<-c("t3260","t8371","t628","t3536","t5725","t7351","t10392")

Env_anal_all<-merge(data_long_met,Env,by.y = c("site_coll$Location","site_coll$Year","site_coll$Day"),by.x=c("Site","Year","Day"))
Env_anal_all <- subset(Env_anal_all,Species=="Fv" & Site != "Green")
Env_anal_all <- subset(Env_anal_all,Env_anal_all$ASVid %in% SIMPER)
